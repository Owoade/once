...
const korapay_node_1 = __importDefault(require("korapay-node"));
(0, dotenv_1.config)();
...
exports.korapay = new korapay_node_1.default(process.env.KORAPAY_SECRET_KEY, process.env.KORAPAY_PUBLIC_KEY);
